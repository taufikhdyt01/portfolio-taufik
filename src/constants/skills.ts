...
export const toolList: Skill[] = [
  ...
  },
  {
    ...
    title: "Laragon",
    description: "Laragon is a powerful, fast, and lightweight local development environment for web applications.",
  },
  {
